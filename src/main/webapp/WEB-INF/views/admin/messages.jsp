                        ...
                        <div
                            ...
                            <div class="glass-card" style="padding: 1rem; display: flex; flex-direction: column;">
                                ...
                                <div style="border-top: 1px solid var(--border-color); padding-top: 1rem;">
                                    <p style="font-size: 0.8rem; color: var(--text-secondary); text-align: center;">V
                                ...
                                <div style="flex-grow: 1; overflow-y: auto;">
                                    ...
                                    <div style="padding: 1.5rem; border-bottom: 1px solid var(--border-color); cursor: pointer;"
                                        ...
                                        <div
                                            ...
                                            <span style="font-size: 0.8rem; color: var(--text-secondary);">2h ago</span>
                                        </div>
                            ...
                            <div id="history-view" class="glass-card"
                                ...
                                <div style="flex-grow: 1; overflow-y: auto;">
                                        ...
                                        <div style="padding: 1.5rem; border-bottom: 1px solid var(--border-color);">
                                            <div
                                                ...
                                                <span class="status-badge"
                                                    style="background: ${a.priority == 'High' ? 'rgba(239, 68, 68, 0.1)' : (a.priority == 'Medium' ? 'rgba(245, 158, 11, 0.1)' : 'rgba(59, 130, 246, 0.1)')}; color: ${a.priority == 'High' ? '#ef4444' : (a.priority == 'Medium' ? '#f59e0b' : '#3b82f6')};">
                                                    ${a.priority}
                                                </span>
                                                <span
                                                    style="font-size: 0.8rem; color: var(--text-secondary);">${a.createdAt}</span>
                                            </div>
                                    ...
                                    <c:if test="${empty announcements}">
                                        <div style="padding: 3rem; text-align: center; color: var(--text-secondary);">No
